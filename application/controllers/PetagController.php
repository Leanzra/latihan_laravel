...
class PetagController extends CI_Controller {
    ...
    public function update($id) {
        ...
        $data = array(
            ...
            'no_telepon' => $this->input->post('no_telepon'),
            'jk' => $this->input->post('jk'),
            'foto_profil' => $foto_profil ? $foto_profil : $this->input->post('foto_profil_lama'),
            'username' => $this->input->post('username'),
            'password' => !empty($this->input->post('password')) ? md5($this->input->post('password')) : $this->input->post('password_lama'),
            'biaya_admin' => $this->input->post('biaya_admin'),
            'akses' => $this->input->post('akses')
        );
